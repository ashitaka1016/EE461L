		  ...
		  <div class="table-responsive">
            <table class="table table-striped" style="width:50%">
              ...
              <tbody>
					...
					%>
					<tr>
						<td><% SimpleDateFormat dateFormatter = new SimpleDateFormat("EEEE, MMMM d, yyyy");
                  			   out.print("" + dateFormatter.format(e.getDates().get(i))); %></td>
						<td><% out.print(e.getAmounts().get(i)); %></td>
					</tr> <%
					}
					%>
	               </tbody>
