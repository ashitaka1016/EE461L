      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li style="padding-bottom:20px"><a href="viewtimeline.jsp">View Timeline</a></li>
          </ul>
          <ul class="nav nav-sidebar">
		  ...
		  <div class="table-responsive">
            <table class="table table-striped">
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><%if(request.getSession().getAttribute("currentEmployee") != null) { out.print(((Employee)request.getSession().getAttribute("currentEmployee")).getName()); }%></td>
                </tr>
                <tr>
                  <td>ID:</td>
                  <td><%if(request.getSession().getAttribute("currentEmployee") != null) { out.print(((Employee)request.getSession().getAttribute("currentEmployee")).getID()); }%></td>
                </tr>
                <tr>
                  <td>Last Paid On:</td>
                  <td></td>
